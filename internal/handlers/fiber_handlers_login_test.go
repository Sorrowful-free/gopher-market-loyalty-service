...
func TestLoginHandler(t *testing.T) {
	...
	t.Run("successful_login", func(t *testing.T) {
		userService.EXPECT().Login(gomock.Any(), gomock.Any(), gomock.Any()).Return(models.EmptyUserModel, nil)
	...
	t.Run("failed_login_with_wrong_credentials", func(t *testing.T) {
		userService.EXPECT().Login(gomock.Any(), gomock.Any(), gomock.Any()).Return(models.EmptyUserModel, services.NewUserServiceError(services.UserServiceErrorUserNotFound, "User not found"))
	...
	t.Run("failed_login_with_internal_error", func(t *testing.T) {
		userService.EXPECT().Login(gomock.Any(), gomock.Any(), gomock.Any()).Return(models.EmptyUserModel, errors.New("internal error"))
